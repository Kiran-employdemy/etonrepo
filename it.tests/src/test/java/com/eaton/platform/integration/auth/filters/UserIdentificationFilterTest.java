...
public class UserIdentificationFilterTest {
    ...
    @InjectMocks
    UserIdentificationFilter userIdentificationFilter;
    ...
    public void testDoFilter() throws IOException, ServletException {
        userIdentificationFilter.doFilter(context.request(), context.response(), filterChain);
