...
<html>
<head>
    <title><%= i18n.get("AEM Akamai Replication") %> | <%= xssAPI.encodeForHTML(title) %></title>
...
<body>
    ...
    %>
        ...
        CQ.WCM.edit({
            ...
            "dialog":"/apps/eaton/components/replication/akamai/dialog",
            "type":"eaton/components/replication/akamai",
            "editConfig":{
                "xtype":"editbar",
                "listeners":{
