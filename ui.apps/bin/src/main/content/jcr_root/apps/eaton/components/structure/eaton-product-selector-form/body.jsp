...
<%@ page import="com.adobe.aemds.guide.utils.GuideUtils,
				 ...
				 com.eaton.platform.core.vgselector.helpers.VGProductSelectorHelper,
                 java.util.Iterator" %>
<body>
<%
    
    VGProductSelectorHelper vgHelper = new VGProductSelectorHelper();
    vgHelper.setOptionsOnPageLoad(resource, resourceResolver, sling);
