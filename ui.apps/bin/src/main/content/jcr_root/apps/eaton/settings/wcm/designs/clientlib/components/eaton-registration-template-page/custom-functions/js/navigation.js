...
function eatonValidateCurrentPanel() {
  var currentPanelSom = guideBridge._guide.rootPanel.navigationContext.currentItem.somExpression;
...
function eatonNextPanel(emailSom) {
  ...
  if (eatonValidateCurrentPanel() && checkValidationStatus(emailSom)) {
    ...
    changeButtonVisibility(guideBridge._guide.rootPanel.navigationContext.currentItem.somExpression);
  }
}
...
function checkValidationStatus(fieldSom) {
  var fieldElem = guideBridge.resolveNode(fieldSom);
