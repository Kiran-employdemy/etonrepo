...
var customEvents = {
  ...
  filterSelected: function filterSelected(filter, toRemove) {
    var customEvent = new CustomEvent('filterSelected');customEvent.filter = filter;customEvent.toRemove = toRemove;return customEvent;
  },
  filterDeselected: function filterDeselected(facetId) {
    var customEvent = new CustomEvent('filterDeselected');customEvent.facetId = facetId;return customEvent;
  },
  newTabEventWithArgument: function newTabEventWithArgument(argument) {
    return new CustomEvent('triggerNewTabEvent', argument);
  },
  applyDateClicked: function applyDateClicked(startDate, endDate) {
    var customEvent = new CustomEvent('applyDateClicked');customEvent.startDate = startDate;customEvent.endDate = endDate;return customEvent;
  },
  sortOptionSelected: function sortOptionSelected(sortOption) {
    var customEvent = new CustomEvent('sortOptionSelected');customEvent.sortOption = sortOption;return customEvent;
  }
};
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
  module.exports = { sessionStorageKeys: sessionStorageKeys, customEvents: customEvents, searchPrefixes: searchPrefixes, querySelectorFor: querySelectorFor, elementClasses: elementClasses, elementIdOf: elementIdOf };
}