...
$(document).ready(function () {
  ...
  $('.primary-navigation__items a').click(function () {
    ...
    var lengthOfCol = $('.mega-menu__content--active').find('.mega-menu-custom-col').find('.mega-menu-custom-col-2').find('.links-list__col').length;
    var lengthOfCol2 = $('.mega-menu__content--active').find('.mega-menu-custom-col').find('.mega-menu-custom-col-2').length;
    var customFlex = lengthOfCol * 25 + '%';
    var customFlex2 = 100 / lengthOfCol2 + '%';
