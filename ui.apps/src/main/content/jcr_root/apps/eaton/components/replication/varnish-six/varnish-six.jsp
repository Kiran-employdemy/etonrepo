...
--%><%@page contentType="text/html"
            pageEncoding="utf-8"
            import="com.day.cq.replication.Agent,com.day.cq.replication.AgentConfig,com.day.cq.replication.AgentManager,com.day.cq.replication.ReplicationQueue,com.adobe.granite.ui.clientlibs.HtmlLibraryManager,com.day.cq.i18n.I18n" %><%
...
<body>
    ...
    %>
        ...
        CQ.WCM.edit({
            ...
            "dialog":"/apps/eaton/components/replication/varnish-six/dialog",
            "type":"eaton/components/replication/varnish-six",
            "editConfig":{
                "xtype":"editbar",
                "listeners":{
