...
/**
 * <html> Description: This bean class used in RelatedProductsModel class to store content </html> .
 *
 * @author TCS
 * @version 1.0
 * @since 2017
 */
public class RelatedProductsBean implements Serializable, RelatedProductsService {
