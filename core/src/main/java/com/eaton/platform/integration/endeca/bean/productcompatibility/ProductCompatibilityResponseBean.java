...
public class ProductCompatibilityResponseBean implements Serializable {
    ...
    private List<ProductCompatibilityModuleBean> familyModule;
	 ...
	 */
	public List<ProductCompatibilityModuleBean> getFamilyModule() {
		return familyModule;
	}
	 ...
	 */
	public void setFamilyModule(List<ProductCompatibilityModuleBean> familyModule) {
