...
public class CategoryCacheImpl extends BullseyeCacheImpl {


    public static final String NAME = "categorycache";
    ...
    public boolean isCacheService(String name) {
        return CategoryCacheImpl.NAME.equals(name);
    }
