...
public class CountryListCacheImpl extends BullseyeCacheImpl {

    public static final String NAME = "countrylistcache";
    ...
    public boolean isCacheService(String name) {
        return CountryListCacheImpl.NAME.equals(name);
    }
    ...
    public String getCacheKey() {
        return CountryListCacheImpl.NAME;
    }
}
